...
NsMap::registerTagClass("a:ea", CTTextFont::class);
NsMap::registerTagClass("a:eastAsian", CTTextFont::class);
NsMap::registerTagClass("a:cs", CTTextFont::class);
NsMap::registerTagClass("a:complexScript", CTTextFont::class);
